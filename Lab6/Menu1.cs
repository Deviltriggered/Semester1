...
namespace Lab6
{
    ...
    static class Menu1
    {
        ...
        /// <returns></returns>
        private static double Maths(double a, double b)
        {
            double answer = 0;
        ...
        /// <returns></returns>
        private static double Jeopardy(double answer)
        {
            int tries = 3;
            double userAnswer = 0;
            while (tries != 0)
        ...
        private static void DivisionTest(double dividend, double divisor)
        {
            double test = 0;
            try
            {
