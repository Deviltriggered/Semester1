...
namespace Lab6
{
    ...
    internal class Menu4
    {
        ...
        /// <returns></returns>
        private string[,] MaskGrid(string[,] mask)
        {
        ...
        /// <param name="grid">Игровое поле.</param>
        /// <returns></returns>
        private int[,] FormatGrid(int[,] grid)
        {
            for (int x = 0; x < grid.GetLength(0); x++)
            {
                for (int y = 0; y < grid.GetLength(1); y++)
        ...
        /// <param name="grid">Игровое поле.</param>
        /// <param name="mask">Интерфейс пользователя.</param>
        private void Coordinates(int[,] grid, string[,] mask)
        {
        ...
        /// <returns></returns>
        private bool GameProcess(string[,] mask, int[,] grid, bool gameOver)
        {
